...
export function buildNewProductRecords(manifest, guideRecord) {
  return (manifest.newProducts || []).map((p) => ({
    ...
    affiliateStatus: p.affiliateStatus || 'unverified',
    sourceUrl: p.sourceUrl || '',
    sourceVerifiedAt: p.sourceVerifiedAt || null,
    priceSourceUrl: p.priceSourceUrl || '',
    availabilityStatus: p.availabilityStatus || 'unverified',
    fitGuidance: p.fitGuidance || '',

...
export const guides = [
  ...
  {
    id: "dickies-874-dark-brown",
    heroProductId: "dickies-874-dark-brown",
    title: "5 Ways to Style Dickies 874 Work Pants",
    slug: "guide-dickies-874-dark-brown.dc.html",
    ...
    coverImage: "assets/images/guides/dickies-874-dark-brown/cover.png",
    slideImages: [
      { src: "assets/images/guides/dickies-874-dark-brown/slide-01.png", label: "Cover" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-02.png", label: "Clean City Uniform" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-03.png", label: "Modern Workwear" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-04.png", label: "Smart Casual" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-05.png", label: "Skate Influence, Grown Up" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-06.png", label: "Summer Minimalist" },
      { src: "assets/images/guides/dickies-874-dark-brown/slide-07.png", label: "Shop the Look" },
    ],
    outfitCount: 5,
    ...
    outfits: [
      {
        ...
        items: [
          { name: "Original 874® Work Pants", productId: "dickies-874-dark-brown" },
          { name: "Oversized Cream Tee", productId: "cream-tee" },
          { name: "Minimal Watch", productId: "minimal-watch" },
        ],
      },
    ...
    relatedProducts: ["dickies-874-dark-brown", "cream-tee", "minimal-watch", "gap-overshirt-beige", "knit-polo", "cap"],
    instagramUrl: "",
    publishedDate: null,
